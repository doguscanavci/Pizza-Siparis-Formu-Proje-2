const Success = ({ orderData }) => {
  ...
  if (!orderData) {
    return <div className="bg-[#ce2829] min-h-screen flex items-center justify-center text-white text-2xl font-bold">Sipariş verisi bekleniyor...</div>;
  }
        ...
        <div className="hidden md:flex flex-col items-center w-full max-w-[800px]">
          ...
          <div className="flex flex-col items-start w-[350px] mb-12 text-left">
            ...
            <div className="flex flex-col gap-4 text-base font-light text-white/90">
              <p className="pl-15">
                Boyut: <strong className="font-bold text-white">{orderData.size}</strong>
              </p>
              <p className="pl-15">
                Hamur: <strong className="font-bold text-white">{orderData.dough}</strong>
              </p>
          ...
          <div className="border border-white rounded-md p-10 w-[350px]">
            ...
            <div className="space-y-4 font-medium">
              <div className="flex justify-between items-center text-lg">
                <span>Seçimler</span>
                <span>{orderData.extrasPrice}₺</span>
              </div>
              <div className="flex justify-between items-center text-lg">
                <span>Toplam</span>
